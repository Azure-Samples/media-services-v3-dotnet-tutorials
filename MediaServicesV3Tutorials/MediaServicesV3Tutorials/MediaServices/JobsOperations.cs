...
namespace Microsoft.Media.Encoding.Rest.ArmClient
{
    ...
    /// </summary>
    internal partial class JobsOperations : IServiceOperations<AzureMediaServicesClient>, IJobsOperations
    {
        /// <summary>
        ...
        /// </exception>
        internal JobsOperations(AzureMediaServicesClient client)
        {
            if (client == null)
            {
        ...
        public async Task<AzureOperationResponse<IPage<Job>>> ListWithHttpMessagesAsync(string transformName, ODataQuery<Job> odataQuery = default(ODataQuery<Job>), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<Page<Job>>(_responseContent, Client.DeserializationSettings);
                }
        ...
        public async Task<AzureOperationResponse<Job>> GetWithHttpMessagesAsync(string transformName, string jobName, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if ((int)_statusCode == 200)
            {
                ...
                try
                {
                    _result.Body = Microsoft.Rest.Serialization.SafeJsonConvert.DeserializeObject<Job>(_responseContent, Client.DeserializationSettings);
                }
                catch (JsonException ex)
                {
                    _httpRequest.Dispose();
