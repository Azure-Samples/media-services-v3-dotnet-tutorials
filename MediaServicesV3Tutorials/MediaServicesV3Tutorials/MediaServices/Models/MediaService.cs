...
namespace Microsoft.Media.Encoding.Rest.ArmClient.Models
{
    ...
    /// </summary>
    [JsonTransformation]
    public partial class MediaService : IResource
    {
        /// <summary>
        ...
        /// resource.</param>
        public MediaService(System.Guid mediaServiceId, string name = default(string), string id = default(string), string type = default(string), string location = default(string), object tags = default(object), IList<StorageAccount> storageAccounts = default(IList<StorageAccount>))
        {
            Name = name;
            Id = id;
            Type = type;
