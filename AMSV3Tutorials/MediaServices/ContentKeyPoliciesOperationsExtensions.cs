...
namespace Microsoft.Media.Encoding.Rest.ArmClient
{
    ...
    public static partial class ContentKeyPoliciesOperationsExtensions
    {
            ...
            /// </param>
            public static ContentKeyPolicy CreateOrUpdate(this IContentKeyPoliciesOperations operations, string resourceGroupName, string accountName, string contentKeyPolicyName, ContentKeyPolicy parameters)
            {
                return operations.CreateOrUpdateAsync(resourceGroupName, accountName, contentKeyPolicyName, parameters).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ContentKeyPolicy> CreateOrUpdateAsync(this IContentKeyPoliciesOperations operations, string resourceGroupName, string accountName, string contentKeyPolicyName, ContentKeyPolicy parameters, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.CreateOrUpdateWithHttpMessagesAsync(resourceGroupName, accountName, contentKeyPolicyName, parameters, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// The request parameters
            /// </param>
            public static ContentKeyPolicy Update(this IContentKeyPoliciesOperations operations, string resourceGroupName, string accountName, string contentKeyPolicyName, ContentKeyPolicy parameters)
            {
                return operations.UpdateAsync(resourceGroupName, accountName, contentKeyPolicyName, parameters).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<ContentKeyPolicy> UpdateAsync(this IContentKeyPoliciesOperations operations, string resourceGroupName, string accountName, string contentKeyPolicyName, ContentKeyPolicy parameters, CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.UpdateWithHttpMessagesAsync(resourceGroupName, accountName, contentKeyPolicyName, parameters, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
