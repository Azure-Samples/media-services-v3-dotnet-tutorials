...
namespace Microsoft.Media.Encoding.Rest.ArmClient.Models
{
    ...
    public partial class StreamingPolicy : ProxyResource
    {
        ...
        public StreamingPolicy(string id = default(string), string name = default(string), string type = default(string), System.DateTimeOffset created = default(System.DateTimeOffset), string defaultContentKeyPolicyName = default(string), EnvelopeEncryption envelopeEncryption = default(EnvelopeEncryption), CommonEncryptionCenc commonEncryptionCenc = default(CommonEncryptionCenc), CommonEncryptionCbcs commonEncryptionCbcs = default(CommonEncryptionCbcs), NoEncryption noEncryption = default(NoEncryption))
            : base(id, name, type)
        {
            Created = created;
