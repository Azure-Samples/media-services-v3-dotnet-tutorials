...
namespace Microsoft.Media.Encoding.Rest.ArmClient.Models
{
    ...
    public partial class JobError
    {
        ...
        /// Initializes a new instance of the JobError class.
        /// </summary>
        /// <param name="code">Code describing the error. Possible values
        ...
        /// <param name="category">Category to help caller categorize the
        /// error. Possible values include: 'Service', 'Download', 'Upload',
        /// 'Configuration', 'Content'</param>
        /// <param name="retry">Indication that the job may be retried. If
        /// retry is unsuccessful, please contact support. Possible values
        /// include: 'DoNotRetry', 'MayRetry'</param>
        ...
        /// <summary>
        /// Gets code describing the error. Possible values include:
        ...
        /// <summary>
        /// Gets category to help caller categorize the error. Possible values
        /// include: 'Service', 'Download', 'Upload', 'Configuration',
        /// 'Content'
        /// </summary>
        ...
        /// <summary>
        /// Gets indication that the job may be retried. If retry is
