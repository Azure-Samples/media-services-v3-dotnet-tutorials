...
namespace Microsoft.Media.Encoding.Rest.ArmClient.Models
{
    ...
    public partial class StreamingLocator : ProxyResource
    {
        ...
        /// Locator</param>
        public StreamingLocator(string id = default(string), string name = default(string), string type = default(string), string assetName = default(string), System.DateTimeOffset created = default(System.DateTimeOffset), System.DateTimeOffset? startTime = default(System.DateTimeOffset?), System.DateTimeOffset? endTime = default(System.DateTimeOffset?), System.Guid? streamingLocatorId = default(System.Guid?), string streamingPolicyName = default(string), string defaultContentKeyPolicyName = default(string), IList<StreamingLocatorUserDefinedContentKey> contentKeys = default(IList<StreamingLocatorUserDefinedContentKey>))
            : base(id, name, type)
        {
            AssetName = assetName;
            Created = created;
