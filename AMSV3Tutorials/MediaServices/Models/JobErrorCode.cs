...
namespace Microsoft.Media.Encoding.Rest.ArmClient.Models
{
    ...
    public struct JobErrorCode : System.IEquatable<JobErrorCode>
    {
        ...
        /// reachable, please should check the availability of the destination.
        /// </summary>
        ...
        /// <summary>
        /// There was a problem with input files and the configuration
        /// combination, fix the configuration and retry with the same input,
        /// or change input to match the configuration.
        /// </summary>
        public static readonly JobErrorCode ConfigurationUnsupported = "ConfigurationUnsupported";

        /// <summary>
        /// There was a problem with the input content (i.e. zero byte files,
