...
namespace Microsoft.Media.Encoding.Rest.ArmClient.Models
{
    ...
    public partial class LiveOutput : ProxyResource
    {
        ...
        public LiveOutput(string id = default(string), string name = default(string), string type = default(string), string description = default(string), string assetName = default(string), System.TimeSpan? archiveWindowLength = default(System.TimeSpan?), string manifestName = default(string), Hls hls = default(Hls), long? outputSnapTime = default(long?), System.DateTimeOffset? created = default(System.DateTimeOffset?), System.DateTimeOffset? lastModified = default(System.DateTimeOffset?), string provisioningState = default(string), LiveOutputResourceState? resourceState = default(LiveOutputResourceState?))
            : base(id, name, type)
        {
